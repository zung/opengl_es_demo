package com.example.myapplication.multiplelighting
...
class MultipleLightingActivity : AppCompatActivity() {
    private var glSurfaceView: GLSurfaceView? = null

    val myGLRenderer = MyGLRenderer(this, MultipleLighting::class.java)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_multiple_lighting)
